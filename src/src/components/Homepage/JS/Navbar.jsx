                        ...
                        <span>Registration Form</span>
                                            ...
                                            <div className="container LogInContainer">
                                                <form>
                                                    ...
                                                    <div class="form-group ">
                                                        <input type="text" class=" Registration-Input-box" placeholder='Userid' id="Username" />
                                                    </div>
                                                    ...
                                                    <div class="form-group ">
                                                        <input type="text" class=" Registration-Input-box" id="inputAddress" placeholder="Address" />
                                                    </div>
                                                    {/* <div class="form-group ">
