    ...
    return (
        <>
            ...
            <div className='container my-5'>
                <div className="Heading mb-4 blog-text">
                    <span>Exclusive collection of travel blogs</span>
                    ...
                    <div class="col-md-3">
                        <div class="card h-100 shadow">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Goa is a lot on the radar of my mind these days. Goa, as they say, is a vibe and I was lucky....</p>
                                <p>
                    ...
                    <div class="col-md-3">
                        <div class="card h-100 shadow">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Ladakh is a lot on the radar of my mind these days. Ladakh, as they say, is a vibe and I was lucky....</p>
                                <button type="button" class="btn btn-outline-info">Read more</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card h-100 shadow">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Nilachal is a lot on the radar of my mind these days. Nilachal, as they say, is a vibe and I was lucky....</p>
                                <button type="button" class="btn btn-outline-info">Read more</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card h-100 shadow">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Pondicheri is a lot on the radar of my mind these days. Pondicheri, as they say, is a vibe and I was lucky....</p>
                                <button type="button" class="btn btn-outline-info">Read more</button>
                            </div>
                        </div>
                    </div>
