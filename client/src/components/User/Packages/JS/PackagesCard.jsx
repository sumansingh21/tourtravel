        ...
        <>
            ...
            <div className="container-fluid">
                <div className="container-fluid package-filter">
                    ...
                    <div>
                        <button className="filter-button">View Results</button>
                    </div>
                </div>
                <div className="container-fluid packages-cards-content">
                    <div class="row packages-cards-content-row">
                        ...
                        <div class="col-lg-3 CardlastSec">
                            Price on request
                            <div><button type="button">View Details</button></div>
                            <div><button type="button">Get a free quotes</button></div>
                        </div>
                    </div>
                    <div class="row packages-cards-content-row">
                        <div class="col-lg-3 packages-card-image">
